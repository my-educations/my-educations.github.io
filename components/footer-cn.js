  ...
  <footer class="container-fluid bg-footer" style="color:#000;background:#fff;">
    ...
    <div class="row">
      ...
      <div class="col-sm-3">
        <div class="row">
          <div class="col-sm-4 text-center">
            <p style="font-size:60%;">微信公众号3</p>
          </div>
          <div class="col-sm-4 text-center">
            <p style="font-size:60%;">微信公众号4</p>
          </div>
          <div class="col-sm-4">
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-sm-3 text-center">
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <a href="https://www.instagram.com/studymax2" class="fa fa-instagram" target="_blank"></a>
      ...
      <div class="col-sm-6 text-center">
        ...
        <div class="row">
          ...
          <a href="info-cn.html" target="_blank">资讯信息</a>&nbsp;&nbsp;
        </div>
        <div class="row">
